...
if(isset($_SESSION['user']) && isset($_SESSION['pass']) && isset($_SESSION['estatus'])){

	/*Consultas para la generacionde la carga en la cabrzea.*/
	$cedula=$_SESSION['cedula'];
	$sqlDatosPersonal = "SELECT nombre, apellido, img_perfil from personal where cedula = '$cedula'";
	$resDatosPer = mysql_query($sqlDatosPersonal, $conexion);
	while ($res = mysql_fetch_array($resDatosPer)) {
		$nombreC = $res["nombre"]." ". $res["apellido"];
		$img = $res["img_perfil"];
	}

	//cantidad se seguidores en redes sociales
	...
	$twitter = twitter_followers_count("elsancochoo");
	//print_r($twitter);
	$seguidores= $twitter['followers_count'];

	$twitter2 = twitter_followers_count("webpapagayo");
	//print_r($twitter);
	$seguidores2= $twitter2['followers_count'];
...
<head>
	...
	<meta charset="utf-8">
	<title>Administración Papagayo</title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1, user-scalable=no">
	<meta name="description" content="Administración de papagayo. Manejo de nomina y proyectos.">
				...
				<ul class="nav navbar-nav pull-left hidden-xs" id="navbar-left">
					<li class="dropdown">
						<a href="#" class="team-status-toggle dropdown-toggle tip-bottom" data-toggle="tooltip" title="Toggle Team View">
							<i class="fa fa-users"></i>
							<span class="name">Estatus de Equipo</span>
				...
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown user" id="header-user">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							...
							<span class="username"><?php echo $nombreC; ?></span>
							<i class="fa fa-angle-down"></i>
						</a>
						<ul class="dropdown-menu">
							...
							<li><a href="php/cerrarSesion.php"><i class="fa fa-power-off"></i> Cerrar Sesión</a></li>
						</ul>
					</li>
				...
				<div id="sidebar" class="sidebar">
					<div class="sidebar-menu nav-collapse">
						...
						<ul>
							<li class="active">
								<a href="index.html">
								<i class="fa fa-tachometer fa-fw"></i> <span class="menu-text">Principal</span>
						...
						<div class="row">
									 ...
									 <div class="dashbox panel panel-default">
										<div class="panel-body">
										   ...
										   <div class="panel-right">
												<div class="number"><?php echo $seguidores2 ?></div>
												<div class="title">Papagayo</div>
								  ...
								  <div class="col-lg-6">
									 <div class="dashbox panel panel-default">
										<div class="panel-body">
										   ...
										   <div class="panel-right">
												<div class="number" ><?php echo $seguidores; ?></div>
											



												<div class="title">El sancocho</div>
							...
							<div class="col-md-6">
								<div class="box solid grey">
									<div class="box-title">
										<h4><i class="fa fa-money"></i>Estadisticas de Ingresos</h4>
										<div class="tools">
...
<?php
    ...
    echo "<br><br><br><center><b>Error de acceso: Necesitas iniciar sesion <br><a href='login.html'> Ir a pagina de acceso</a> </b></center>";
   }
?>